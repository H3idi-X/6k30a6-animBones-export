...
namespace UnityEngine.U2D.Animation
{
    internal abstract class BaseDeformationSystem
    {
        ...
        protected NativeArray<int> m_BoneTransformsLastChangedFrame;
        ...
        protected virtual void InitializeArrays()
        {
            ...
            m_BoneTransformsLastChangedFrame = new NativeArray<int>(startingCount, Allocator.Persistent);
        }
        ...
        protected virtual void ResizeAndCopyArrays(int updatedCount)
        {
            ...
            NativeArrayHelpers.ResizeAndCopyIfNeeded(ref m_BoneTransformsLastChangedFrame, updatedCount);
        }
        ...
        internal virtual void Cleanup()
        {
            ...
            m_BoneTransformsLastChangedFrame.DisposeIfCreated();
        ...
        protected void PrepareDataForDeformation(out JobHandle localToWorldJobHandle, out JobHandle worldToLocalJobHandle)
        {
            ...
            using (Profiling.boneTransformsChangeDetection.Auto())
            {
                ...
                BoneTransformsChangeDetectionJob boneTransformChangeDetectionJob = new BoneTransformsChangeDetectionJob
                {
                    ...
                    boneTransformsLastChangedFrame = m_BoneTransformsLastChangedFrame,
        ...
        internal int GetBoneTransformsLastChangedFrame(SpriteSkin spriteSkin)
        {
            return m_BoneTransformsLastChangedFrame[spriteSkin.dataIndex];
        }
